...
import { LoginComponent as DefaultLoginComponent, LoginComponentProps } from 'next-password-protect/dist/esm/src/hoc/LoginComponent';
...
interface PasswordProtectHOCOptions {
  ...
  bypassProtection?: (route: any) => boolean;
}
